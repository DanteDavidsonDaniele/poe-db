...
from app.repository.items import insert_item, insert_price_log
...
# def formatPriceData(data: ScoutCurrencyResponse):
#     formattedPriceData = []
#     for item in data.get("Items"):
#         item_id = item["ItemId"]
...
#     if data is None:
#         return
#     formattedPriceData = formatPriceData(data)
#     for entry in formattedPriceData:
#         insert_price_log(entry) 
